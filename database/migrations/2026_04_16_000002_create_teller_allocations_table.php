...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('teller_allocations', function (Blueprint $table) {
            ...
            $table->index(['user_id', 'currency_code', 'session_date', 'status'], 'teller_alloc_user_curr_sess_status_idx');
            $table->index(['counter_id', 'session_date'], 'teller_alloc_counter_sess_idx');
            $table->index(['branch_id', 'session_date'], 'teller_alloc_branch_sess_idx');
