    ...
    <div class="app-shell">
        ...
        <aside class="sidebar">
            ...
            <nav class="flex-1 overflow-y-auto px-3 pb-6">
                ...
                {{-- POS --}}
                <div class="nav-section">
                    <div class="nav-section-title">POS</div>
                    <a href="/pos" class="nav-item {{ request()->is('pos') && !request()->is('pos/*') ? 'active' : '' }}">
                        <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/pos/transactions" class="nav-item {{ request()->is('pos/transactions') ? 'active' : '' }}">
                        <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                        </svg>
                        <span>Transactions</span>
                    </a>
                    <a href="/pos/rates" class="nav-item {{ request()->is('pos/rates*') ? 'active' : '' }}">
                        <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span>Rates</span>
                    </a>
                    <a href="/pos/inventory" class="nav-item {{ request()->is('pos/inventory*') ? 'active' : '' }}">
                        <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
