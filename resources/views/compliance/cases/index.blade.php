...
<div class="flex items-center gap-3">
    <a href="/compliance/cases/create" class="btn btn-primary">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="text-sm">{{ $case->type->label() ?? 'Unknown' }}</span>
                    </td>
                    <td>
                        @if($case->customer)
                    ...
                    <td>
                        <div class="table-actions">
                            <a href="/compliance/cases/{{ $case->id }}" class="btn btn-ghost btn-icon" title="View">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <tr>
                    <td colspan="8">
                        <div class="empty-state py-12">
                            ...
                            <a href="/compliance/cases/create" class="btn btn-primary mt-4">New Case</a>
                        </div>
                    </td>
                </tr>
                @endforelse
