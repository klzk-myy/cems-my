...
<div class="form-header">
    <h2>Create AML Rule</h2>
    <p>Configure a new Anti-Money Laundering rule for transaction monitoring</p>
</div>
...
<form action="{{ route('compliance.rules.store') }}" method="POST" class="form-card">
    @csrf
    ...
    <div class="btn-group">
        ...
        <a href="{{ route('compliance.rules.index') }}" class="btn-cancel">Cancel</a>
    </div>
</form>
