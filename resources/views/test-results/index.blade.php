...
<head>
    ...
    <title>Test Results - CEMS-MY</title>
...
<body class="font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 bg-[#f7f7f8] p-8 overflow-y-auto">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-[#171717]">Test Results</h1>
                <p class="text-sm text-[#6b6b6b] mt-1">System test and quality assurance</p>
            </div>
            <div class="bg-white border border-[#e5e5e5] rounded-xl overflow-hidden">
                <table class="w-full text-sm">
                    <thead class="bg-[#f7f7f8] border-b border-[#e5e5e5]">
                        <tr>
                            <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-[#6b6b6b]">Test</th>
                    ...
                    <tbody>
                        <tr>
                            <td colspan="3" class="px-4 py-8 text-center text-[#6b6b6b]">No test results available</td>
                        </tr>
                    </tbody>
                </table>
            </div>
