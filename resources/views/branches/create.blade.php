...
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-semibold text-[--color-ink]">Create Branch</h1>
        <p class="text-sm text-[--color-ink-muted] mt-1">Add a new branch</p>
    </div>
        ...
        <form action="{{ route('branches.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="code" class="w-full px-3 py-2 border border-[--color-border] rounded-lg text-sm" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-[--color-ink] mb-2">Branch Name</label>
                    <input type="text" name="name" class="w-full px-3 py-2 border border-[--color-border] rounded-lg text-sm" required>
                </div>
                <div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2" class="w-full px-3 py-2 border border-[--color-border] rounded-lg text-sm"></textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-[--color-ink] mb-2">Phone</label>
                    <input type="text" name="phone" class="w-full px-3 py-2 border border-[--color-border] rounded-lg text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-[--color-ink] mb-2">Email</label>
                    <input type="email" name="email" class="w-full px-3 py-2 border border-[--color-border] rounded-lg text-sm">
                </div>
            </div>
            <div class="mt-6">
