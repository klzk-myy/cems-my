    ...
    <div class="p-6">
        ...
        <form wire:submit="approve">
            <div class="mb-4">
                ...
                <textarea wire:model="note" class="w-full px-4 py-2.5 text-sm bg-white border border-[--color-border] rounded-lg" rows="2" placeholder="Note for HQ approval"></textarea>
            </div>
