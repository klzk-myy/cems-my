<div class="card">
    ...
    <div class="p-6">
        ...
        <form wire:submit="dispatchTransfer">
            <div class="mb-4">
                <label class="block text-sm font-medium text-[--color-ink] mb-1">Dispatch Note</label>
                <textarea wire:model="note" class="w-full px-4 py-2.5 text-sm bg-white border border-[--color-border] rounded-lg" rows="2" placeholder="Optional dispatch notes"></textarea>
            </div>
