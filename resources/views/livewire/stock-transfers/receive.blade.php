    ...
    <div class="p-6">
            ...
            <tbody>
                ...
                <tr class="border-t border-[--color-border-subtle]">
                    ...
                    <td class="py-2 text-right font-mono">
                        <input type="number" wire:model="received.{{ $item->id }}" value="{{ $item->quantity_sent ?? 0 }}" min="0" class="w-20 px-2 py-1 text-sm text-right border border-[--color-border] rounded">
                    </td>
                </tr>
                @endforeach
            </tbody>
        ...
        <form wire:submit="receive">
            <div class="mb-4">
                ...
                <textarea wire:model="note" class="w-full px-4 py-2.5 text-sm bg-white border border-[--color-border] rounded-lg" rows="2" placeholder="Note any discrepancies"></textarea>
            </div>
