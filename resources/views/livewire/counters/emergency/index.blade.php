<div class="card max-w-2xl">
    ...
    <div class="p-6">
        ...
        <form wire:submit="emergencyClose">
            <div class="mb-6">
                <label class="block text-sm font-medium text-[--color-ink] mb-2">Reason for Emergency Closure</label>
                <textarea wire:model="reason" class="w-full px-4 py-2.5 text-sm bg-white border border-[--color-border] rounded-lg" rows="3" required placeholder="Explain why this emergency closure is necessary..."></textarea>
            </div>
