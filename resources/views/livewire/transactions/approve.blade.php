<div>
    ...
    <div class="max-w-4xl mx-auto">
                ...
                @if($this->has_high_priority_flags)
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start gap-3 p-4 bg-[--color-danger]/5 rounded-lg border border-[--color-danger]/10">
                            ...
                            <div class="flex-1">
                                <p class="font-medium text-[--color-danger]">{{ $flag->flag_type->label() }}</p>
        ...
        @if(!$this->has_high_priority_flags)
            ...
            <div class="card">
                <div class="card-body">
                    <p class="text-sm text-[--color-ink-muted] mb-4">By clicking "Approve Transaction", you confirm that:</p>
                    <ul class="text-sm text-[--color-ink-muted] mb-4 list-disc list-inside">
