...
<div>
    <div class="card-header">
        ...
        <p class="text-sm text-gray-500">Enter transaction details and exchange rate</p>
    </div>
    <div class="card-body space-y-6">
        ...
        <div class="form-group">
            ...
            <div class="grid grid-cols-2 gap-4">
                <label class="flex items-center gap-3 p-4 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors has-[:checked]:border-amber-500 has-[:checked]:bg-amber-500/5
                    {{ $type === 'Buy' ? 'border-amber-500 bg-amber-500/5' : '' }}">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Customer sells foreign currency to us</p>
                    </div>
                </label>
                <label class="flex items-center gap-3 p-4 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors has-[:checked]:border-amber-500 has-[:checked]:bg-amber-500/5
                    {{ $type === 'Sell' ? 'border-amber-500 bg-amber-500/5' : '' }}">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Customer buys foreign currency from us</p>
                    </div>
                </label>
            </div>
            @error('type')
        ...
        <div class="grid grid-cols-2 gap-6">
            <div class="form-group">
                <label class="form-label">
                    Exchange Rate
                    <span class="text-xs text-gray-500 ml-1">(Daily Rate)</span>
                </label>
                <div class="flex items-center gap-2">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $amountLocal ? number_format((float)$amountLocal, 2) : '0.00' }}" class="form-input bg-gray-100" readonly>
            </div>
        </div>
