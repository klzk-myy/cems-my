<div class="min-h-screen bg-[var(--color-background)] p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <h1 class="text-2xl font-bold text-[var(--color-ink)] mb-6">Edit Stock Item</h1>
        ...
        <form wire:submit="save" class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex justify-end gap-4 mt-6">
                <a href="{{ route('stock.show', $stockItem->id) }}" class="px-4 py-2 border border-[var(--color-border)] rounded">Cancel</a>
