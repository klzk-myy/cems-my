    ...
    <div class="card lg:col-span-2">
        ...
        <div class="card-body">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="{{ route('compliance.alerts.index') }}" class="flex flex-col items-center gap-3 p-4 rounded-xl bg-[--color-canvas-subtle] hover:bg-[--color-canvas-emphasis] transition-colors">
                ...
                <a href="{{ route('compliance.cases.index') }}" class="flex flex-col items-center gap-3 p-4 rounded-xl bg-[--color-canvas-subtle] hover:bg-[--color-canvas-emphasis] transition-colors">
                ...
                <a href="{{ route('compliance.edd.index') }}" class="flex flex-col items-center gap-3 p-4 rounded-xl bg-[--color-canvas-subtle] hover:bg-[--color-canvas-emphasis] transition-colors">
                ...
                <a href="{{ route('str.create') }}" class="flex flex-col items-center gap-3 p-4 rounded-xl bg-[--color-canvas-subtle] hover:bg-[--color-canvas-emphasis] transition-colors">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-[--color-ink-muted]">{{ \Carbon\Carbon::parse($alert['created_at'])->diffForHumans() }}</td>
                    <td>
                        @php
