...
<div>
    <h1 class="text-2xl font-semibold text-gray-900">Compliance Cases</h1>
    <p class="text-sm text-gray-500">Manage compliance investigation cases</p>
</div>
@endsection
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-gray-500">{{ $case->created_at->format('d M Y') }}</td>
                    <td>
