...
<aside class="sidebar">
    ...
    <nav class="flex-1 overflow-y-auto px-3 pb-6">
        ...
        <div class="nav-section">
            <a href="/dashboard" class="nav-item {{ $this->isActive('dashboard') ? 'active' : '' }}">
            ...
            <a href="/rates" class="nav-item {{ $this->isActive('rates') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @endif
            <a href="/setup" class="nav-item {{ $this->isActive('setup') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="nav-section">
            ...
            <a href="/transactions" class="nav-item {{ $this->isActive('transactions') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>
                </svg>
                <span>Transactions</span>
            </a>
            <a href="/customers" class="nav-item {{ $this->isActive('customers') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="nav-section">
            ...
            <a href="/counters" class="nav-item {{ $this->isActive('counters') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/branches" class="nav-item {{ $this->isActive('branches') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="nav-section">
            ...
            <a href="/stock-cash" class="nav-item {{ $this->isActive('stock-cash') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                </svg>
                <span>Stock & Cash</span>
            </a>
            <a href="/stock-transfers" class="nav-item {{ $this->isActive('stock-transfers') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>
                </svg>
        ...
        <div class="nav-section">
            ...
            <a href="/compliance" class="nav-item {{ $this->isActive('compliance') && !$this->isActive('compliance/') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                </svg>
                <span>Compliance</span>
            </a>
            <a href="/compliance/workspace" class="nav-item {{ $this->isActive('compliance/workspace') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                </svg>
                <span>Workspace</span>
            </a>
            <a href="/compliance/alerts" class="nav-item {{ $this->isActive('compliance/alerts') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/compliance/cases" class="nav-item {{ $this->isActive('compliance/cases') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                </svg>
                <span>Cases</span>
            </a>
            <a href="/compliance/edd" class="nav-item {{ $this->isActive('compliance/edd') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span>EDD Records</span>
            </a>
            <a href="/compliance/findings" class="nav-item {{ $this->isActive('compliance/findings') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
                </svg>
                <span>Findings</span>
            ...
            <a href="/compliance/rules" class="nav-item {{ $this->isActive('compliance/rules') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                </svg>
                <span>AML Rules</span>
            </a>
            <a href="/compliance/sanctions" class="nav-item {{ $this->isActive('compliance/sanctions') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
                </svg>
                <span>Sanction Lists</span>
            </a>
            <a href="/compliance/ctos" class="nav-item {{ $this->isActive('compliance/ctos') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span>CTOS Reports</span>
            </a>
            <a href="/compliance/risk-dashboard" class="nav-item {{ $this->isActive('compliance/risk-dashboard') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path>
                </svg>
                <span>Risk Dashboard</span>
            </a>
            <a href="/compliance/reporting" class="nav-item {{ $this->isActive('compliance/reporting') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span>Reporting</span>
            </a>
            <a href="/str" class="nav-item {{ $this->isActive('str') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="nav-section">
            ...
            <a href="/accounting" class="nav-item {{ $this->isActive('accounting') && !$this->isActive('accounting/') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/accounting/journal" class="nav-item {{ $this->isActive('accounting/journal') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                </svg>
                <span>Journal Entries</span>
            </a>
            <a href="/accounting/ledger" class="nav-item {{ $this->isActive('accounting/ledger') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 6h16M4 10h16M4 14h16M4 18h16"></path>
                </svg>
                <span>Ledger</span>
            </a>
            <a href="/accounting/trial-balance" class="nav-item {{ $this->isActive('accounting/trial-balance') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/accounting/profit-loss" class="nav-item {{ $this->isActive('accounting/profit-loss') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 17h8m0 0V9m0 8l-8-8-4 4-6-6"></path>
                </svg>
                <span>Profit & Loss</span>
            </a>
            <a href="/accounting/balance-sheet" class="nav-item {{ $this->isActive('accounting/balance-sheet') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                </svg>
                <span>Balance Sheet</span>
            </a>
            <a href="/accounting/cash-flow" class="nav-item {{ $this->isActive('accounting/cash-flow') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span>Cash Flow</span>
            </a>
            <a href="/accounting/ratios" class="nav-item {{ $this->isActive('accounting/ratios') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
                <span>Financial Ratios</span>
            </a>
            <a href="/accounting/revaluation" class="nav-item {{ $this->isActive('accounting/revaluation') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/accounting/reconciliation" class="nav-item {{ $this->isActive('accounting/reconciliation') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                </svg>
                <span>Reconciliation</span>
            </a>
            <a href="/accounting/budget" class="nav-item {{ $this->isActive('accounting/budget') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                </svg>
                <span>Budget</span>
            </a>
            <a href="/accounting/periods" class="nav-item {{ $this->isActive('accounting/periods') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </svg>
                <span>Periods</span>
            </a>
            <a href="/accounting/fiscal-years" class="nav-item {{ $this->isActive('accounting/fiscal-years') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </svg>
        ...
        <div class="nav-section">
            ...
            <a href="/reports" class="nav-item {{ $this->isActive('reports') && !$this->isActive('reports/') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span>Reports</span>
            </a>
            <a href="/reports/msb2" class="nav-item {{ $this->isActive('reports/msb2') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span>MSB2 Report</span>
            </a>
            <a href="/reports/lctr" class="nav-item {{ $this->isActive('reports/lctr') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 657a2 2 0 100-4 2 2 0 000 4zm0 0v6a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2v6z"></path>
                </svg>
                <span>LCTR</span>
            </a>
            <a href="/reports/lmca" class="nav-item {{ $this->isActive('reports/lmca') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                <span>LMCA</span>
            </a>
            <a href="/reports/quarterly-lvr" class="nav-item {{ $this->isActive('reports/quarterly-lvr') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
                <span>Quarterly LVR</span>
            </a>
            <a href="/reports/position-limit" class="nav-item {{ $this->isActive('reports/position-limit') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                </svg>
                <span>Position Limits</span>
            </a>
            <a href="/reports/history" class="nav-item {{ $this->isActive('reports/history') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="nav-section">
            ...
            <a href="/transactions/batch-upload" class="nav-item {{ $this->isActive('transactions/batch-upload') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/users" class="nav-item {{ $this->isActive('users') ? 'active' : '' }}">
                <svg class="nav-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                </svg>
                <span>Users</span>
