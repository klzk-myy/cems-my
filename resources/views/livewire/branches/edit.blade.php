<div class="min-h-screen bg-[var(--color-background)] p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <h1 class="text-2xl font-bold text-[var(--color-ink)] mb-6">Edit Branch</h1>
        ...
        <form wire:submit="save" class="bg-white rounded-lg shadow p-6">
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-[var(--color-ink)]">Code</label>
                    <input type="text" wire:model="code" class="mt-1 block w-full rounded border border-[var(--color-border)] px-3 py-2" />
            ...
            <div class="flex justify-end gap-4 mt-6">
                <a href="{{ route('branches.show', $branch->id) }}" class="px-4 py-2 border border-[var(--color-border)] rounded">Cancel</a>
