<div class="min-h-screen bg-[var(--color-background)] p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <h1 class="text-2xl font-bold text-[var(--color-ink)] mb-6">Create Branch</h1>
        ...
        <form wire:submit="save" class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex justify-end gap-4 mt-6">
                <a href="{{ route('branches.index') }}" class="px-4 py-2 border border-[var(--color-border)] rounded">Cancel</a>
