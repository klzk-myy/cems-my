...
<head>
    ...
    <title>Branch Opening - Step 3 - CEMS-MY</title>
...
<body class="font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 bg-[#f7f7f8] p-8 overflow-y-auto">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-[#171717]">Step 3: Review & Confirm</h1>
                <p class="text-sm text-[#6b6b6b] mt-1">Review branch opening summary</p>
            </div>
            <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
                <p class="text-[#6b6b6b] mb-4">Total Pool Amount: RM {{ number_format($totalPoolAmount ?? 0, 2) }}</p>
                <a href="{{ route('branches.open.complete', $branch->id ?? 0) }}" class="inline-block px-4 py-2 text-sm font-medium text-white bg-[#0a0a0a] rounded-lg hover:bg-[#262626]">Complete Branch Opening</a>
            </div>
        </main>
    </div>
</body>
