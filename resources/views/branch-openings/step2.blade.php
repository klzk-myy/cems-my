...
<head>
    ...
    <title>Branch Opening - Step 2 - CEMS-MY</title>
...
<body class="font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 bg-[#f7f7f8] p-8 overflow-y-auto">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-[#171717]">Step 2: Currency Pools</h1>
                <p class="text-sm text-[#6b6b6b] mt-1">Configure initial currency holdings for the branch</p>
            </div>
            <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
                <p class="text-[#6b6b6b] mb-4">Branch: {{ $branch->code ?? 'N/A' }} - {{ $branch->name ?? 'New Branch' }}</p>
                <p class="text-[#6b6b6b]">Configure currency pools for this branch.</p>
            </div>
        </main>
    </div>
</body>
