...
<head>
    ...
    <title>Branch Opening Complete - CEMS-MY</title>
...
<body class="font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 bg-[#f7f7f8] p-8 overflow-y-auto">
            <div class="mb-6">
                <h1 class="text-2xl font-semibold text-[#171717]">Branch Opening Complete</h1>
                <p class="text-sm text-[#6b6b6b] mt-1">Branch has been successfully initialized</p>
            </div>
            <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
                <p class="text-[#171717]">Branch {{ $branch->code ?? 'N/A' }} - {{ $branch->name ?? 'N/A' }} has been successfully opened.</p>
                <div class="mt-4">
                    <a href="{{ route('dashboard') }}" class="px-4 py-2 text-sm font-medium text-white bg-[#0a0a0a] rounded-lg hover:bg-[#262626]">Return to Dashboard</a>
                </div>
            </div>
        </main>
    </div>
